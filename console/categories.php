    ...
    <div class="modal-content">
      <form id="add-form" action="" method="post">
        <div class="modal-header">
          <h4 id="modal-title" class="modal-title">Add Categories</h4>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form id="edit-form" action="" method="post">
        <div class="modal-header">
          <h4 id="modal-title" class="modal-title">Edit Categories</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<script>
  ...
  function openDeleteModal(data) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const url = "http_client.php?action=DELETE_CATEGORY&id=" + formData.id
        $.ajax({
          type: "POST",
          url: url,
          data: formData,
  ...
  $("#add-form").submit(function(event) {
    ...
    const url = "http_client.php?action=CREATE_CATEGORY"
    $.ajax({
      type: "POST",
      url: url,
      data: formData,
  ...
  $('#edit-form').submit(function(event) {
    ...
    const url = "http_client.php?action=UPDATE_CATEGORY&id=" + formData.id
    $.ajax({
      type: "POST",
      url: url,
      data: formData,
